...
echo -e "--------------------------------------------------------"
SERVICES=("vpnmaster-backend" "nginx" "openvpn@server" "ufw" "fail2ban")
...
PACKAGES=("openvpn" "openvpn" "nginx" "nginx" "python3" "python3" "pip" "pip" "node" "node" "npm" "npm" "git" "git" "curl" "curl" "ufw" "ufw" "sqlite3" "sqlite3")
